...
var InfiniteMenu = /*#__PURE__*/function () {
  ...
  _createClass(InfiniteMenu, [{
    ...
    value: function scrollUpdate() {
      ...
      // 스크롤 끝과 처음 수정부분
      if (this.scrollPos > this.scrollHeight - this.clonesHeight) {
        // Scroll to the top when you’ve reached the bottom
        this.setScrollPos(10); // Scroll down 1 pixel to allow upwards scrolling
      } else if (this.scrollPos < 10) {
        // Scroll to the bottom when you reach the top
        this.setScrollPos(this.scrollHeight - this.clonesHeight - this.scrollPos);
      }
    }
  }, {
    key: "render",
